function NoSong() {
  return (
    <div className="bg-gradient-to-bl from-blue-400 to-green-500 via-#65a30d animate-gradient-x min-h-screen lg:flex lg:justify-center lg:items-center  md:flex md:justify-center md:items-center">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="bg-white bg-opacity-25 backdrop-filter backdrop-blur-lg p-4 rounded-3xl shadow-lg grid grid-cols-1 gap-4 flex flex-col md:flex-row justify-center items-center">
          ...
          <h2 className="text-white text-4xl font-bold">try again tomorrow.</h2>
        </div>
      </div>
    </div>
  );
